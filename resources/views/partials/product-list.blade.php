    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="rounded position-relative fruite-item">
            <div class="fruite-img">
                <img src="{{ asset('/storage/menus/' . $menu->image) }}" class="img-fluid w-100 rounded-top" alt="">
            </div>
            ...
            <div class="p-4 border border-primary border-top-0 rounded-bottom">
                ...
                <div class="d-flex justify-content-between flex-lg-wrap">
                    ...
                    <form action="{{ route('pesan') }}" method="post">
                        ...
                        <button type="submit" class="btn border border-secondary rounded-pill text-primary mt-2 align-items-right">
