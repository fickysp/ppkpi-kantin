        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="index.html" class="navbar-brand">
                    <h1 class="text-primary display-6">KantinDigital</h1>
                </a>
                        ...
                        <a href="#" class="my-auto">
                            ...
                            <div class="nav-item dropdown no-arrow none" style="text-decoration: none">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    ...
                                    @auth
                                        <span
                                            class="mr-2 d-none d-lg-inline text-gray-700 medium">{{ auth()->user()->fullname }}</span>
                                    @endauth
                                </a>
        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">KantinDigital</h1>
                            <p class="text-secondary mb-0">Mempermudah keseharianmu</p>
                        </a>
                    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <p>Address: PPKPI Jakarta, Cijantung, Jakarta Timur</p>
                        <p>Email: ppkpi@gmail.com</p>
